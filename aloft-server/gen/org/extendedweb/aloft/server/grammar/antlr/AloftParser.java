...
public class AloftParser extends Parser {
	...
	public static final int
		...
		QUOTES=75, COMMENT_BLOCK_DECLARATION=76, WS=77, STATEMENT_END=78, ROUTES_KEYWORK=79;
	public static final int
	...
	public final RContext r() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 125382376161342L) != 0) || _la==NEW_LINE );
			setState(97);
			match(EOF);
			}
		}
	...
	public static class RoutesContext extends ParserRuleContext {
		public TerminalNode ROUTES_KEYWORK() { return getToken(AloftParser.ROUTES_KEYWORK, 0); }

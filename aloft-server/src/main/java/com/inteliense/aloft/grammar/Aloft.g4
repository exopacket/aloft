...
SWITCH_CURLY_BLOCK : ([{]([ ]+)) ((( ('case')(([ ]+)(([0-9]+)|(["'])([^"'])*(["'])|'null')[:]) | ( ('default')[:] ) | ('break')[;])* | ((SYNTAX | (((GOTO_DECLARATION | PATH_STRING | IF_DECLARATION | LOOP_DECLARATION | NUMBERS | PROPERTY  | NAMED_VAR | NULL_VALUE | CURLY_OBJECT_BLOCK | BRACES_ARRAY_BLOCK) ([,]))*)? (PATH_STRING | NUMBERS | PROPERTY | NAMED_VAR | NULL_VALUE | BRACES_ARRAY_BLOCK)))* (([ ]+)[}]))) ;

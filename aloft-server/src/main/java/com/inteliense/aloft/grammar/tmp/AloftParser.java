...
public class AloftParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, CLASS_ACCESS=3, KEYWORDS=4, NAMED=5, NAMED_WITH_EMPTY_PARAMS=6, 
		NAMED_VAR=7, ISSET_KEYWORD=8, IF_KEYWORD=9, OPEN_PARENTHESES=10, CLOSE_PARENTHESES=11, 
		ELSE=12, ELSE_IF=13, COMMA=14, VAR_ACCESS=15, REQUIRED_FIELD=16, VAR_MAGIC=17, 
		LOOP_DECLARATION=18, SWITCH_KEYWORD=19, SWITCH_CURLY_BLOCK=20, ARRAY_TYPE_SUFFIX=21, 
		FUNCTION=22, FUNCTION_TYPES=23, TYPES=24, ENCLOSED_WITH_ARGS=25, NAMED_WITH_PARAMS_SPECIAL=26, 
		CONDITIONAL_IF=27, CONDITIONAL_ELSE=28, OPERATORS=29, PROPERTY_VALUES=30, 
		NUMBERS=31, DECIMALS=32, DIGITS=33, HTML_ELEMENT=34, NULL_VALUE=35, EMPTY_PARENTHESIS=36, 
		NAMED_PARENTHESIS_SPECIAL=37, NAMED_PARENTHESIS_FUNCTIONS=38, NAMED_DOT=39, 
		NAMED_CLASS_ARRAY=40, NAMED_OBJECT=41, NAMED_OBJECT_ARRAY=42, NAMED_ARRAY=43, 
		GO_TO=44, GOTO_KEYWORD=45, PATH_STRING=46, QUOTED_STRING=47, STATIC_ACCESS=48, 
		COLON=49, EQUALS=50, NOT=51, APPEND_ADD=52, APPEND_SUBTRACT=53, PATH_START=54, 
		OPEN_BRACKETS=55, CLOSE_BRACKETS=56, END_OF_FILE=57, QUOTES=58, COMMENT_BLOCK_DECLARATION=59, 
		NEW_LINE=60, WS=61, STATEMENT_END=62, BRACES_ARRAY_BLOCK=63;
	public static final int
		...
		RULE_keyword = 16, RULE_expression = 17, RULE_isset = 18, RULE_empty_function = 19, 
		RULE_if = 20, RULE_declare_variable = 21, RULE_variable = 22, RULE_any_var = 23, 
		RULE_var_name = 24, RULE_variable_options = 25, RULE_var_options = 26, 
		RULE_property = 27, RULE_property_value = 28, RULE_loop = 29, RULE_switch_block = 30, 
		RULE_curly_block = 31, RULE_functions = 32, RULE_var_type = 33, RULE_condtional = 34, 
		RULE_enclosed_var = 35, RULE_named_switch = 36, RULE_enclosed_vars = 37, 
		RULE_path = 38, RULE_string = 39;
	private static String[] makeRuleNames() {
		return new String[] {
			"r", "syntax", "class", "class_declaration", "class_access", "component", 
			"element", "theme", "model", "page", "animation", "module", "query", 
			"source", "callable", "constructor", "keyword", "expression", "isset", 
			"empty_function", "if", "declare_variable", "variable", "any_var", "var_name", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "CLASS_ACCESS", "KEYWORDS", "NAMED", "NAMED_WITH_EMPTY_PARAMS", 
			"NAMED_VAR", "ISSET_KEYWORD", "IF_KEYWORD", "OPEN_PARENTHESES", "CLOSE_PARENTHESES", 
	...
	public final RContext r() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1126999968744122L) != 0) );
			}
		}
	...
	public static class KeywordContext extends ParserRuleContext {
		public TerminalNode KEYWORDS() { return getToken(AloftParser.KEYWORDS, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AloftListener ) ((AloftListener)listener).enterKeyword(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AloftListener ) ((AloftListener)listener).exitKeyword(this);
		}
	}
	...
	public final IssetContext isset() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_isset);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Empty_functionContext empty_function() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_empty_function);
		try {
			enterOuterAlt(_localctx, 1);
			{
			{
	...
	public final Declare_variableContext declare_variable() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_declare_variable);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Any_varContext any_var() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_any_var);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Variable_optionsContext variable_options() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_variable_options);
		try {
			setState(253);
			_errHandler.sync(this);
	...
	public final Var_optionsContext var_options() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_var_options);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(255);
	...
	public final Property_valueContext property_value() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_property_value);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(263);
	...
	public final Switch_blockContext switch_block() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_switch_block);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(267);
	...
	public final Curly_blockContext curly_block() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_curly_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final CondtionalContext condtional() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_condtional);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final Enclosed_varContext enclosed_var() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_enclosed_var);
		try {
			setState(316);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Named_switchContext named_switch() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_named_switch);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Enclosed_varsContext enclosed_vars() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_enclosed_vars);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 16544L) != 0) );
			setState(331);
			match(CLOSE_PARENTHESES);
			}
		}

...
CURLY_BLOCK : ( ([{])OPT_WHITESPACE?) ( ('continue')[;] |  ('break')[;] | SYNTAX | ((((GOTO_DECLARATION | IF_DECLARATION | LOOP_DECLARATION | NUMBERS | PROPERTY | PATH_STRING | NAMED_VAR | NULL_VALUE | CURLY_OBJECT_BLOCK | BRACES_ARRAY_BLOCK) ([,]))*)? (NUMBERS | PROPERTY | PATH_STRING | NAMED_VAR | NULL_VALUE | BRACES_ARRAY_BLOCK)))* (OPT_WHITESPACE?([}])) ;
SWITCH_CURLY_BLOCK : ([{]OPT_WHITESPACE?) ((( ('case')(([ ]+)(([0-9]+)|(["'])([^"'])*(["'])|'null')[:]) | ( ('default')[:] ) | ('break')[;])* | ((SYNTAX | (((GOTO_DECLARATION | PATH_STRING | IF_DECLARATION | LOOP_DECLARATION | NUMBERS | PROPERTY  | NAMED_VAR | NULL_VALUE | CURLY_OBJECT_BLOCK | BRACES_ARRAY_BLOCK) ([,]))*)? (PATH_STRING | NUMBERS | PROPERTY | NAMED_VAR | NULL_VALUE | BRACES_ARRAY_BLOCK)))* (OPT_WHITESPACE?[}]))) ;
...
BRACES_ARRAY_BLOCK : ( [[](OPT_WHITESPACE)?([)]) (((NUMBERS | PATH_STRING | NAMED_VAR | NULL_VALUE | CURLY_OBJECT_BLOCK | BRACES_ARRAY_BLOCK) (([,])))*)? (NUMBERS | PATH_STRING | NAMED_VAR | NULL_VALUE | BRACES_ARRAY_BLOCK)? ((OPT_WHITESPACE)?[\]])) ;
CURLY_OBJECT_BLOCK : ( ([{])OPT_WHITESPACE?([)]) (((NUMBERS | PROPERTY | PATH_STRING | NAMED_VAR | NULL_VALUE | CURLY_OBJECT_BLOCK | BRACES_ARRAY_BLOCK) (([,])))*)? (NUMBERS | PROPERTY | PATH_STRING | NAMED_VAR | NULL_VALUE | BRACES_ARRAY_BLOCK)? (OPT_WHITESPACE?([}]))) ;

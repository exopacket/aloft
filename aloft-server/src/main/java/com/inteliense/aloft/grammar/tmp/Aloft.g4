...
component : keyword var_name curly_block ;
element : keyword var_name curly_block ;
theme : keyword var_name  curly_block ;
model : keyword var_name  curly_block ;
page : keyword path curly_block ;
animation : keyword var_name  curly_block ;
module : keyword var_name  curly_block ;
//TODO make params a rule for query and more (arg1, arg2, ...args)
query : keyword  (NAMED_WITH_PARAMS_SPECIAL | NAMED_WITH_EMPTY_PARAMS) curly_block ;
source : keyword PATH_STRING STATEMENT_END? ;
callable : keyword PATH_STRING curly_block ;
constructor : keyword  curly_block ;
keyword : KEYWORDS ;
KEYWORDS : ('create') | ('callable') | ('source') | ('query') | ('module') | ('theme') | ('element') | ('component') ;

...
public interface AloftListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AloftParser#variable_options}.
	 * @param ctx the parse tree
	 */
	void enterVariable_options(AloftParser.Variable_optionsContext ctx);
	/**
	 * Exit a parse tree produced by {@link AloftParser#variable_options}.
	 * @param ctx the parse tree
	 */
	void exitVariable_options(AloftParser.Variable_optionsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link AloftParser#enclosed_var}.
	 * @param ctx the parse tree
	 */
	void enterEnclosed_var(AloftParser.Enclosed_varContext ctx);
	/**
	 * Exit a parse tree produced by {@link AloftParser#enclosed_var}.
	 * @param ctx the parse tree
	 */
	void exitEnclosed_var(AloftParser.Enclosed_varContext ctx);
	/**
